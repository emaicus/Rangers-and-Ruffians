...
## Highborn 
![Highborn](images/class/highborn.jpg?raw=true "Highborn") 
...
##### Combat Abilities:   
  ...
  * **Combo**: On a critical hit with a blunt weapon or your hands, attack again and gain one chi point.  
    
##### Advantages:   
  * **Steady**: Do not take disadvantage when being jostled about.  
  * **Inner Eye**: Gain advantage when checking for spiritual energy and mask your own spirtual energy.  
    
##### General Abilities:   
  * **Meditate**: Gain either 1d6+2 additional healing or 1 chi point during a short rest.  
  * **Share Ability**: At sunup each day, you may choose one of your party's abilities to be yours until sunup the next morning.  
  * **The Book of Chi**: You start with The Book of Chi, and may spend three points within it.  
...
##### Starting Items:   
  * **Shifting Cloak**: You possess a unique cloak, which takes on the color of your surroundings. +5 in stealth checks when standing still.  
...
##### General Abilities:   
  * **Minor Medicine**: If you have the ingredients, you can create basic potions.  
  * **Tracker**: You are an expert tracker, and have advantage when looking for trails and sign of passage.  
...
##### Combat Abilities:   
  ...
  * **Double Tap**: Every three turns, you can shoot two arrows at a time.  
...
## Gunslinger 
![Gunslinger](images/class/gunslinger.jpg?raw=true "Gunslinger") 
...
##### Advantages:   
  * **Regular Patron**: You have +3 on charisma checks made in a tavern.  
...
##### Advantages:   
  ...
  * **Slight of Hand**: You have advantage and +3 dexterity when performing slight of hand actions.  
  * **All Smiles**: You have advantage on Charisma checks.  
...
## Rouge 
![Rouge](images/class/rouge.jpg?raw=true "Rouge") 
