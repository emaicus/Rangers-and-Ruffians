...
def race_helper():
  print("Alright, first we are going to get your race sorted.")
...
def class_helper():
  ...
  print("Alright, let's get you all set up.")

  question = "Which of these sounds best to you?\n\
  1) I want to attack head on, and fight man to man.\n\
  2) My enemy should never see me coming.\n\
  3) I want to cast spells to destroy those who oppose me.\n\
  4) If I play my cards right, I should be able to talk my way out of this.\n\
  5) A well placed arrow should do the trick.\n\
  6) I don't dirty my hands with violence.\
  7) I tend to wounds, not create them."

  combat_style = verifyInput(question, string_nums(7))
  ...
  if answer == "1":
    ...
    help_select_charisma()
  elif answer == "5":
    help_select_archer()
  elif answer == "6":
    help_select_passifict()
  elif answer == "7":
    help_select_healer()
