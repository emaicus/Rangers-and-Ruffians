...
* __Combat Active:__
  ...
  * __Holy Shield:__ (Cost 1) Give an ally a shield with health equal to 2x their level. At higher levels this shield grants 1 turn of invulnerability.
  * __Guardian Ward:__ (Cost 0) Place a ward on an ally which grants a variety of effects as the paladin levels up:
    * __Armor__ The guardian ward grants 1-5 armor depending on level.
    ...
    * __Shared Healing__ If a paladin heals a different ally, an entity with a guardian ward still gains half of the healing.
    * __Guardian Spirit__ When an ally with a guardian ward strikes down an enemy, the paladin regains an action point.
  * __2 Guardian Wards__ At high levels, a paladin can place 2 guardian wards.
